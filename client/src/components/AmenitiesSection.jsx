...
const AmenitiesSection = (props) => {
  ...
  //create random var
  var randomAmenity = Math.floor(Math.random() * props.amenities.length);
        ...
        <div style={{
          ...
          <div>
            ...
            <div>
              <div>
                <div>
                  <div>{props.amenities[Math.floor(Math.random() * props.amenities.length)]}</div>
                  <div>
                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{
                      display: "block", height: "24px", width: "24px", fill: "currentcolor"
                    }}>
